...
//	}
	public AttractionsBean(int attractionsId, String name, String address, String serviceHour, String serviceHour2, String introduction, String phone,
			Blob file1, String fileName) {
		super();
		this.attractionsId = attractionsId;
		this.name = name;
		this.address = address;
